    ...
    connectedCallback() {
        this.innerHTML = `
            <div class="social-links-container">
                ...
                <a class="social-btn" aria-label="Link to X" href="https://x.com/emilavara" target="_blank"><i class="bi bi-twitter-x"></i></a>                
                <a class="social-btn" aria-label="Link to e-mail" href="mailto:emilavara@hotmail.com" target="_blank"><i class="bi bi-envelope-at"></i></a>                
            </div>
        `
    }
}